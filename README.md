...
v2.1.0
1、新增预览页面选择功能，支持选择特定测试用例记录
2、新增导出选定记录功能，可选择性地导出部分测试用例
3、优化预览页面用户体验，增加全选/取消全选功能
4、改进CSV导出格式，更好地处理列表项和特殊字符
5、修复预览页面筛选功能的兼容性问题

v2.2.0
1、新增Priority多选过滤功能，支持同时选择多个优先级进行过滤
2、优化预览页面过滤体验，Priority列支持下拉多选框
3、改进过滤逻辑，支持优先级过滤与其他列文本过滤的组合使用
4、增强用户界面交互，添加优先级选择计数显示
```
